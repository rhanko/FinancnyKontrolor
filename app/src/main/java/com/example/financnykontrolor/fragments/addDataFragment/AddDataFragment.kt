...
class AddDataFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.saveDataButton.setOnClickListener {
            ...
            if (saveData()) {
                ...
                view.findNavController().navigate(R.id.showDataFragment)
            }
        }
    ...
    private fun showPopUpWindow(title : String, message : String) {
        ...
        popUpWindow.setPositiveButton(resources.getString(R.string.ok), null)
        popUpWindow.show()
     ...
     * If it editing existed, it return back to original state
